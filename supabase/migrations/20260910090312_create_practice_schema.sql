...
CREATE TABLE IF NOT EXISTS practice.departments (
...
CREATE TABLE IF NOT EXISTS practice.employees (
  ...
  department_id integer NOT NULL REFERENCES practice.departments(id),
  hire_date date NOT NULL
);

CREATE TABLE IF NOT EXISTS practice.salaries (
  id integer PRIMARY KEY,
  employee_id integer NOT NULL REFERENCES practice.employees(id),
  amount integer NOT NULL,
  from_date date NOT NULL
);

CREATE TABLE IF NOT EXISTS practice.projects (
  id integer PRIMARY KEY,
